                    ...
                    <div class="row mx-0 bg-black-op">
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <span class="font-size-xl text-primary-dark"id="lbltitulo">Acudientes </span><span class="font-size-xl"></span>
                                            ...
                                            ?>
                                               ...
                                               <div class="alert alert-danger" role="alert">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-start">
                                                        ...
                                                        <span> El Correo y/o Contraseña son incorrectos. </span>
                                                    </div>
                                                </div>
                                            <?php
                                            break;
                                ...
                                <div class="bg-image" style="background-image: url('public/assets/img/photos/photo34@3x.png');">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label class="custom-control custom-checkbox">
                                                ...
                                                <span class="custom-control-description">Guardar contraseña</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="mt-30">
                                            <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="#" id="btnadministrador">
                                                <i class="fa fa-user-circle-o"> </i>  Administrador
                                            </a>
                                            
                                            <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="#" id="btnmonitora">
                                                <i class="fa fa-user"></i>  Monitora
                                            </a>
                                        </div>
                                    </div>
                                </form>
